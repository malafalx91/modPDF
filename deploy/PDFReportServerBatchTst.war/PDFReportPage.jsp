...
<body style="background-color:#ffffb5;">
   ...
   <form method="POST" name="GeneraPDF" target="_blank" action="generatepdfreport">
      ...
      <tr>
         ...
         <td width="716"><input type="text" name="template" size="32" value="template.rtf"></td>
      </tr>
      <tr>
         <td width="182" align="center">Dati XML</td>
         <td width="716"><textarea rows="19" name="data" cols="80">&lt;xml attr="aaaa"/&gt;</textarea></td>
      </tr>
      </table>
      <p>
   ...
   <span style="font-family:verdana;font-size:12px">Versione 2.4.1 del 09/03/2011></span><br>
